...
public class BookDTO {
	...
	public int getBookCount() {
		return bookCount; // 총 글 개수
	}
	
	// 밑에 버튼을 깔지 말지를 결정하기 위한 bool 자료형
	public boolean hasNoBoard() {
		return bookCount == 0; //표시할 게시물이 없으면 버튼도 깔 필요 없음
	}
	
	public boolean hasBoard() {
		return bookCount > 0; // 표시할 게시물이 있다면 버튼을 깔아야함
	}
	...
	public String toString() {
		return "BookDTO [bookCount=" + bookCount + ", currentPage=" + currentPage + ", totalPages=" + totalPages
